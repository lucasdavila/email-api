...
# configure sinatra allowing request testing,
# see http://www.sinatrarb.com/testing.html#rspec and http://recipes.sinatrarb.com/p/testing/rspec
...
module SinatraApp
  ...
  def app() described_class end # modular style
end
